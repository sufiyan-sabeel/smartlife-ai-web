  ...
  render() {
    return `
      <nav class="bottom-nav">
        ...
        <a href="#expense" class="nav-item" data-route="expense">
        ...
        <a href="#agent" class="nav-item" data-route="agent">
          <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2a7 7 0 0 1 7 7c0 3-2 5.5-3.5 7.5L12 22l-3.5-5.5C7 14.5 5 12 5 9a7 7 0 0 1 7-7z"></path><circle cx="12" cy="9" r="2"></circle></svg>
          <span>AI Agent</span>
        </a>
      </nav>
    `;
